...
enum class RuleType {
    ...
    @SerialName("COUNT_THRESHOLD")
    COUNT_THRESHOLD,

    /** Any single game has been played N times. */
    @SerialName("PER_GAME_THRESHOLD")
    PER_GAME_THRESHOLD,
...
enum class Metric {
    ...
    @SerialName("GAMES_OWNED")
    GAMES_OWNED,

    @SerialName("DISTINCT_GAMES_PLAYED")
    DISTINCT_GAMES_PLAYED,

    @SerialName("DISTINCT_MECHANICS_PLAYED")
    DISTINCT_MECHANICS_PLAYED,

    @SerialName("GAMES_TAUGHT")
    GAMES_TAUGHT,

    @SerialName("GAMES_RATED")
    GAMES_RATED,

    @SerialName("DISTINCT_PLAYERS")
    DISTINCT_PLAYERS,

    @SerialName("WIN_STREAK")
    WIN_STREAK,

    @SerialName("LOSS_STREAK")
    LOSS_STREAK
}
...
enum class Attribute {
    ...
    @SerialName("SESSION_PLAYER_COUNT")
    SESSION_PLAYER_COUNT,

    @SerialName("SESSION_DURATION_HOURS")
